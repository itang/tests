...
public class RankingsTest {
    ...
    public Object[][] defensiveCopyRankingsData() {
        return new Object[][] { { 5, Lists.newArrayList(A, B, C), Lists.newArrayList(D) },
                { 2, Lists.newArrayList(A, B, C, D), Lists.newArrayList(E, F) },
                { 1, Lists.newArrayList(), Lists.newArrayList(A) },
                { 1, Lists.newArrayList(A), Lists.newArrayList(B) },
                { 1, Lists.newArrayList(ZERO), Lists.newArrayList(B) },
                { 1, Lists.newArrayList(ZERO), Lists.newArrayList() } };
    }
    ...
    public Object[][] simulatedRankingsAndOtherRankingsData() {
        return new Object[][] {
                ...
                { Lists.newArrayList(G, B, F, A, C), Lists.newArrayList(D, E, H),
    ...
    public Object[][] duplicatesData() {
        ...
        return new Object[][] { { Lists.newArrayList(ANY_RANKABLE, ANY_RANKABLE, ANY_RANKABLE) },
    ...
    public Object[][] removeZeroRankingsData() {
        return new Object[][] {
                ...
                { Lists.newArrayList(ZERO), Lists.newArrayList() },
                { Lists.newArrayList(ZERO, new RankableObjectWithFields("ZERO2", 0)), Lists.newArrayList() },
                {
                        Lists.newArrayList(B, ZERO, new RankableObjectWithFields("ZERO2", 0), D,
                                new RankableObjectWithFields("ZERO3", 0), new RankableObjectWithFields("ZERO4", 0), C),
                        Lists.newArrayList(D, C, B) }, { Lists.newArrayList(A, ZERO, B), Lists.newArrayList(B, A) } };
    }
    ...
    public void updatingWithNewRankablesShouldBeThreadSafe() throws InterruptedException {
        ...
        // We are capturing exceptions thrown in Blitzer's child threads into
        // this data structure so that we can properly
